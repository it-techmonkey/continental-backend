...
class PaymentDetailsRepository {
  ...
  PaymentDetailsRepository(this._paymentsService);
...
final paymentDetailsRepoProvider = Provider((ref) {
  final paymentsService = ref.read(paymentsServiceProvider);
  return PaymentDetailsRepository(paymentsService);
});

final paymentDetailsProvider = FutureProvider.family<PaymentDetails, String>((
  ref,
  paymentId,
) {
